...
### Calculate slope parameters for entry date models across all covariates
...
axis(1, tick=T, at=c(0,1,3), lwd=2, lwd.ticks=1, cex.axis=1, labels=c("","Hypermean",""), tcl=0) 
axis(2, tick=T, lwd=2, cex.axis=1, at=c(-5,-3,0,3,7),
  labels=c("","-3","0","3",""), las=1)
...
axis(2, tick=T, lwd=2, cex.axis=1, at=c(-10,-5,0,5,10),
  labels=c("","-5","0","5",""), las=1)
mtext(side=2, line=1.6, text=expression(paste("Mean Effect Sizes" )), 
	outer=FALSE, cex=0.8)
abline(h=0, lty=2)
text(0.9, 7.5, "a)", font=1.5, cex=1.5) 
...
mtext(side=2, line=1.6, text=expression(paste("Year-Specific Size Effect" )), 
	outer=FALSE, cex=0.8)
abline(h=0, lty=2)
text(0.9, 7.5, "b)", font=1.5, cex=1.5)
...
mtext(side=2, line=1.6, text=expression(paste("Year-Specific Date Effect" )), 
	outer=FALSE, cex=0.8)15
abline(h=0, lty=2)
text(0.9, 7.5, "c)", font=1.5, cex=1.5) 
...
mtext(side=2, line=1.6, text=expression(paste("Year-Specific Growth Effect" )), 
	outer=FALSE, cex=0.8)
abline(h=0, lty=2)
text(0.9, 7.5, "d)", font=1.5, cex=1.5) 
